...
```bash
# 최신 릴리즈 다운로드
wget https://github.com/OLSSOO-Inc/dvgateway-releases/releases/latest/download/dvgateway_1.2.0.3_amd64.deb

# 설치
sudo dpkg -i dvgateway_1.2.0.3_amd64.deb
...
| `dvgateway_1.2.0.3_amd64.deb` | Debian/Ubuntu .deb 패키지 |
